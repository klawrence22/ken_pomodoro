...
def count_down(count):
    ...
    count_sec = count % 60
    # Dynamic typing allows for changing the data type for a variable
...
canvas = Canvas(width=200, height=124, bg=YELLOW, highlightthickness=0) #224
# # highlightthicknes is used for making the highlight disappear
# tomato_img = PhotoImage(file="tomato.png")
# canvas.create_image(100, 112, image=tomato_img)
timer_text = canvas.create_text(100, 65, text="00:00", fill="black", font=(FONT_NAME, 48, "bold")) #130
